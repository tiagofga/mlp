...
3. Add or extend focused coverage in `tests/test_activations.cpp`, and use `tests/gradient_check.hpp` when a finite-difference backward-pass check is appropriate.
